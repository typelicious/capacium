"""Cherry Studio MCP adapter.

Config: ~/.cherry-studio/mcp_servers.json
"""
import shutil
...
class CherryStudioAdapter(FrameworkAdapter):

    def __init__(self):
        self.storage = StorageManager()
        self.config_path = Path.home() / ".cherry-studio" / "mcp_servers.json"

    def install_skill(self, cap_name: str, version: str, source_dir: Path, owner: str = "global") -> bool:
        print("Cherry Studio does not support skill symlinking. Use 'mcp-server' kind.")
        return False
