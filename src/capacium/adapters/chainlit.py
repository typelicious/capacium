"""Chainlit MCP adapter.

Config: ~/.chainlit/mcp_config.json
"""
import shutil
...
class ChainlitAdapter(FrameworkAdapter):
    ...
    def __init__(self):
        ...
        self.config_path = Path.home() / ".chainlit" / "mcp_config.json"

    def install_skill(self, cap_name: str, version: str, source_dir: Path, owner: str = "global") -> bool:
        print("Chainlit does not support skill symlinking. Use 'mcp-server' kind.")
        return False
